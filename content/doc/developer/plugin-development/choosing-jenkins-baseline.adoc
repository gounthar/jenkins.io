...
* *Do not use versions no longer supported by the update center*, which is currently anything older than 2.364 for weekly releases, and 2.346.3 for LTS releases.
