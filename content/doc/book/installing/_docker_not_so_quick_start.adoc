...
We'll need two terminals for this. One will be used to run the `docker compose` command, and the other one will be used to check the status of the containers and get some information. +
