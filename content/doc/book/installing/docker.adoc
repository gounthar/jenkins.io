...
We recommend you use the recommended official link:https://hub.docker.com/r/jenkins/jenkins/tags?page=1&name=lts-jdk17[`jenkins/jenkins:lts-jdk17` image] from the link:https://hub.docker.com/[Docker Hub repository].
